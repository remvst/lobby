...
export class LobbyService {
    ...
    async listLobbies(request: ListLobbiesRequest): Promise<ListLobbiesResponse> {
        const { game } = request;
    ...
    async sendTextMessage(request: SendTextMessageRequest): Promise<SendTextMessageResponse> {
    ...
    async sendDataMessage(request: SendDataMessageRequest): Promise<SendDataMessageResponse> {
    ...
    async setMetadata(request: SetMetadataRequest): Promise<SetMetadataResponse> {
        const lobby = await this.storage.lobbies(request.game).item(request.lobbyId).get();
        const participant = await this.storage.participants(request.lobbyId).item(request.userId).get();
    ...
    async sendStatusMessage(request: SendStatusMessageRequest): Promise<SendStatusMessageResponse> {
        const lobby = await this.storage.lobbies(request.game).item(request.lobbyId).get();
